@{
  ...
  FunctionsToExport = @('Forthencho','Test-ModuleVersion','Get-TempModule','Remove-TempModule','Get-ADLockoutSource','Ensure-RSAT','Get-UserOU','Get-WindowsUpdates','Install-WindowsUpdates','Get-O365MailboxUsage','Get-ADUserInfo')
  CmdletsToExport   = @()
  VariablesToExport = @()
  AliasesToExport   = @()
